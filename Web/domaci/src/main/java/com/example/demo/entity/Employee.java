...
public class Employee implements Serializable {
    ...
    // @ManyToOne, many se odnosi uvek na klasu u kojoj se nalazimo
    // one se odnosi uvek na departman
    // "Vise zaposlenih radi u jednom departmanu"
    ...
    /*
        ...
        @JoinTable obavezan u @ManyToMany!!!
    */

    // joinColumns se odnosi na Employee (klasa u kojoj se nalazimo)
    // inverseJoinColumns se odnosi na Project (u Set<Project>)
    // "Vise zaposlenih moze da radi na vise projekata"
    // Bitno koristiti set umesto list i instancirati kao HashSet!!
    @ManyToMany
